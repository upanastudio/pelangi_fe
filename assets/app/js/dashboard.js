...
var Dashboard = function() {
    ...
    //== Bandwidth Charts desainSPK.
    //** Based on Chartjs plugin - http://www.chartjs.org/
    var desain_verifikasiSPK = function() {
        if ($('#m_chart_desain_verifikasiSPK').length == 0) {
            return;
        }

        var ctx = document.getElementById("m_chart_desain_verifikasiSPK").getContext("2d");
        ...
        var config = {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    //fill: 'start',
                    data: [
                        100, 65, 12, 16, 58, 11, 85, 40, 85, 62
                    ]
                }]
            },
            options: {
    ...
    //== Bandwidth Charts produksiSPK.
    //** Based on Chartjs plugin - http://www.chartjs.org/
    var produksi_verifikasiSPK = function() {
        if ($('#m_chart_produksi_verifikasiSPK').length == 0) {
            return;
        }

        var ctx = document.getElementById("m_chart_produksi_verifikasiSPK").getContext("2d");
    ...
    //== Bandwidth Charts HR Karyawan Terlambat.
    //** Based on Chartjs plugin - http://www.chartjs.org/
    var hr_karyawanChart = function() {
        if ($('#m_chart_HR_karyawan').length == 0) {
            return;
        }

        var ctx = document.getElementById("m_chart_HR_karyawan").getContext("2d");
    ...
    return {
        ...
        init: function() {
            ...
            activitiesChart();
            bandwidthChart1();
            desain_verifikasiSPK();
            produksi_verifikasiSPK();
            hr_karyawanChart();
            bandwidthChart2();
            adWordsStat();
            financeSummary();
